    ...
    return (
        <section className="container relative flex h-full flex-1 flex-col space-y-4 py-8">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                the use of Graphite&apos;s Website, located at https://Graphite.com.
            </p>

            <p className="leading-7 [&:not(:first-child)]:mt-6">
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Graphite if you do not agree to
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                We employ the use of cookies. By accessing Graphite, you agreed to
                use cookies in agreement with the Graphite&apos;s Privacy Policy.{' '}
            </p>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                Unless otherwise stated, Graphite and/or its licensors own the
                intellectual property rights for all material on Graphite. All
                intellectual property rights are reserved. You may access this
                from Graphite for your own personal use subjected to restrictions
            ...
            <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
                <li>Republish material from Graphite</li>
                <li>Sell, rent or sub-license material from Graphite</li>
                <li>Reproduce, duplicate or copy material from Graphite</li>
                <li>Redistribute content from Graphite</li>
            </ul>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                website. Graphite does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect
                the views and opinions of Graphite,its agents and/or affiliates.
                ...
                laws, Graphite shall not be liable for the Comments or for any
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                Graphite reserves the right to monitor all Comments and to remove
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                You hereby grant Graphite a non-exclusive license to use,
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                of Graphite; and (d) the link is in the context of general resource
                information.
            </p>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                by sending an e-mail to Graphite. Please include your name, your
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                No use of Graphite&apos;s logo or other artwork will be allowed for
