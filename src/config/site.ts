export const siteConfig = {
    ...
    contact: 'team@Graphite.com',
    name: 'Graphite',
    title: 'Graphite | The Open Source AI Musical Toolkit',
    ...
    links: {
        github: 'https://github.com/FelixNgFender/Graphite',
        discord: 'https://discord.gg/7BkTD7RNRG',
        twitter: 'https://twitter.com/felixcantcode',
        statusPage: 'https://status.Graphite.com/status/Graphite',
    },
    twitter: {
        site: '@felixcantcode',
